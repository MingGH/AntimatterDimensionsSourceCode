...
export const singularityMilestones = {
  ...
  darkDimensionAutobuyers: {
    ...
    effectFormat: x => ((x === 0) ? "无自动购买器" : `自动购买直到第 ${["1", "2", "3", "4"][x - 1]} 暗物质维度`),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ascensionAutobuyers: {
    start: 1e8,
    repeat: 140,
    limit: 4,
    description: "暗物质维度飞升自动购买器",
    effect: completions => completions,
    effectFormat: x => ((x === 0) ? "无自动购买器" : `自动飞升直到第 ${["1", "2", "3", "4"][x - 1]} 暗物质维度`),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  darkAutobuyerSpeed: {
    start: 45,
  ...
  realityDEMultiplier: {
    ...
    repeat: 10000,
    limit: 6,
    description: "基于莱特拉内禁用的维度数量的暗能量倍率",
  ...
  dilatedTimeFromSingularities: {
    ...
    repeat: 0,
    limit: 1,
    description: "奇点提升可重复购买的膨胀时间倍率升级",
  ...
  darkFromGlyphLevel: {
    ...
    repeat: 0,
    limit: 1,
    description: "基于最高符文等级提升暗物质和暗能量产量",
  ...
  dim4Generation: {
    ...
    repeat: 0,
    limit: 1,
    description: "当湮灭可用时，湮灭倍率生成第 4 暗物质维度",
  ...
  darkFromDM4: {
    ...
    repeat: 0,
    limit: 1,
    description: "第 4 暗物质维度数量提升暗物质和暗能量获取",
