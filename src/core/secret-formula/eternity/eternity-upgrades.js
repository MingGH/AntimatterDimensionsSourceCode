...
export const eternityUpgrades = {
  idMultEP: {
    id: 1,
    cost: 5,
    description: () => `基于未花费永恒点数的无限维度倍率 (x+${formatInt(1)})`,
  ...
  idMultEternities: {
    id: 2,
    cost: 10,
    description: () => `基于永恒次数的无限维度倍率
      ((x/${formatInt(200)})^log4(${formatInt(2)}x), 软上限于 ${format(1e5)} 次永恒)`,
    effect() {
